...
2.  Microsoft OneNote for taking notes on research
3.  Zotero for reference management (we have a lab account; integrates with Word or Google Docs)
4.  GitProject for project management
5.  OneDrive AND Group Sharepoint AND local/external hard drives for data backup
6.  Figma for conference posters, graphics, and final figure design
